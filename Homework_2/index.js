...
function sendMessage(useername, message, emitter) {
  emitter.emit('message', useername, message)
}
chatEmitter.on('message', (username, message) => {
  console.log(`${username}: ${message}`)
})

sendMessage('Alic', 'Hallo!', chatEmitter)
sendMessage('Nik', 'How are you?', chatEmitter)
sendMessage('Alex', 'Im fine!', chatEmitter)
