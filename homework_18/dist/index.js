...
function teslaCar(car) {
    console.log(`Марка ${car.make}, модель:${car.model}, двигатель:${car.engine.type}, ${car.engine.horsepower}, год выпуска:${car.year}`);
}
teslaCar(myCar);
const calculateDiscount = (product, discount) => {
    return product.price - product.price * (discount / 100);
};
const phone = { name: 'iPhone11', price: 800 };
